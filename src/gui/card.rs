...
// {
//     fn from(value: Card<'a, Message, Theme, Renderer>) -> Self {
//         let header = Container::new(value.header).style(|theme: &Theme| {
//             let style = theme.appearance(&value.style);
...
//             .width(value.width)
//             .height(value.height);
//         let elem = iced::widget::container(col)
...
// ) -> Element<'a, M, T, R>
// where
//     T: iced::widget::container::StyleSheet,
//     R: renderer::Renderer,
// {
...
//     });
//
//     let col = Column::from_vec(vec![header.into(), content.into()]);
//     container(col)
//         .style(|theme: &iced::Theme| {
//             let palette = theme.extended_palette();
//             container::Appearance::default().with_border(palette.primary.strong.color, 4.0)
//         })
//         .into()
// }
